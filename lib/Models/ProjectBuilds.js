(function() {
  ...
  ProjectBuilds = (function(superClass) {
    ...
    ProjectBuilds.prototype.listBuilds = function(projectId, fn) {
      ...
      return this.get("projects/" + (Utils.parseProjectId(projectId)) + "/builds", fn);
    };
    ...
    ProjectBuilds.prototype.showBuild = function(projectId, buildId, fn) {
      ...
      return this.get("projects/" + (Utils.parseProjectId(projectId)) + "/builds/" + buildId, null, fn);
    };
    ...
    ProjectBuilds.prototype.triggerBuild = function(params, fn) {
      ...
      return this.post("projects/" + (Utils.parseProjectId(params.projectId)) + "/trigger/builds", params, null, fn);
    };
