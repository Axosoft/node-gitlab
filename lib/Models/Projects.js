(function() {
  ...
  Projects = (function(superClass) {
    ...
    function Projects() {
      ...
      this.showFromNamespaceAndProjectName = bind(this.showFromNamespaceAndProjectName, this);
      this.show = bind(this.show, this);
      this.owned = bind(this.owned, this);
    ...
    Projects.prototype.owned = function(params, fn) {
      var cb, data;
      if (params == null) {
        params = {};
      }
      ...
      cb = (function(_this) {
        return function(err, retData) {
          if (err) {
            ...
            _this.debug("Recurse Projects::owned()");
            data = data.concat(retData);
            params.page++;
            return _this.get("projects/all", params, cb);
          } else {
      ...
      return this.get("projects/owned", params, cb);
    };
    ...
    Projects.prototype.showFromNamespaceAndProjectName = function(namespace, projectName, fn) {
      if (fn == null) {
        fn = null;
      }
      this.debug("Projects::showFromNamespaceAndProjectName");
      return this.get("projects/" + namespace + "%2F" + projectName, fn);
    };
    ...
    Projects.prototype.forks = function(params, fn) {
      if (params == null) {
        params = {};
      }
      if (fn == null) {
      ...
      this.debug("Projects::forks()");
      return this.get("projects/" + params.id + "/forks", params, fn);
    };
