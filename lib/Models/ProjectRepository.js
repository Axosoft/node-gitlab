(function() {
  ...
  ProjectRepository = (function(superClass) {
    ...
    ProjectRepository.prototype.addTag = function(params, fn) {
      ...
      return this.post("projects/" + (Utils.parseProjectId(params.id)) + "/repository/tags", params, fn);
    };
    ...
    ProjectRepository.prototype.compare = function(params, fn) {
      ...
      return this.get("projects/" + (Utils.parseProjectId(params.projectId)) + "/repository/compare", params, fn);
    };
